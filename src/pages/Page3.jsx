        ...
        <div className='flex min-h-screen'>
            <div className='relative w-1/2 bg-red-50 flex flex-col justify-center items-center'>
                <div className="absolute top-1/2 -right-2 z-10 flex flex-col space-y-6">
                    ...
                    <button className=" h-6 w-6 inline-flex items-center justify-center rounded-full  bg-orange-400  text-white ">2</button>
            ...
            <div className='w-1/2 flex flex-col justify-center items-center'>
                ...
                <div className="relative w-2/3 px-10 py-24 mt-20 bg-red-50 ">
                    <div className="absolute -top-6 left-5 bg-orange-400 text-white w-11/12 text-center py-4 font-bold rounded">PASO 2</div>
                    <input type="text" placeholder="Código SMS" className='w-full block my-4 bg-white px-4 font-sm py-4 focus:outline-none text-gray-400 rounded appearance-none' />
